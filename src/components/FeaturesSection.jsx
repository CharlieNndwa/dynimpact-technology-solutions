      ...
      <div className="max-w-7xl mx-auto space-y-28">
        ...
        <div className="space-y-12">
          ...
          >
            ...
            >
              Why Choose <span className="text-blue-600">DynImpact?</span>
            </motion.h2>
            <p className="text-slate-600 mt-3 text-base sm:text-lg">
              We combine enterprise-grade products with personalized technical excellence to deliver infrastructure you can rely on.
            </p>
          </motion.div>
