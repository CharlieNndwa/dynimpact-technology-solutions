    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row justify-between items-center gap-12">
        ...
        <div className="w-full lg:w-1/2 space-y-8">
          ...
          >
            DynImpact delivers robust IT infrastructure, structured cabling, server configurations, CCTV security, and end-to-end technical support across South Africa.
          </motion.p>
